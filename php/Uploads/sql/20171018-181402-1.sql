...
INSERT INTO `s_process` VALUES ('11', '1', '1', '1508256000', '1508321575', '1508307529', '重中之重做做改改', '1', '0', '0');
...
INSERT INTO `s_process` VALUES ('19', '1', '1', '1508256000', '1508321487', '1508315439', '张召忠改改改', '1', '0', '0');
...
CREATE TABLE `s_project_commission` (
  ...
  `is_finish` tinyint(1) unsigned NOT NULL COMMENT '完成状态：0-未完成，1-已完成',
  `add_time` int(10) unsigned NOT NULL COMMENT '创建时间',
  `update_time` int(10) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
-- -----------------------------
INSERT INTO `s_project_commission` VALUES ('3', '1', '1', '2', '0.00', '0.00', '0.00', '0.00', '1508220072', '1508220074', '1', '1', '0', '1508224759', '1508224759');
INSERT INTO `s_project_commission` VALUES ('4', '1', '1', '2', '0.00', '0.00', '0.00', '0.00', '1508220072', '1508220074', '0', '0', '0', '1508306603', '1508306603');
