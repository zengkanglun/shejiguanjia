$(function () {
	...
	newUserWeb.find(".first .box .boxLeft .boxUl li:nth-child(5) select").on("change",function () {
		...
		// newUserObj.JobName = $(this).val();
		// newUserWeb.find(".first .box .boxLeft .boxUl li:nth-child(5) input").val($(this).val());
	});
	/*输入手机号*/
	...
	/*输入性别*/
	newUserWeb.find(".first .box .boxRight .boxUl li:nth-child(2) input").on("input",function () {
		newUserObj.Sex = $(this).val();
	});
	/*参加工作时间*/
