...
{
	#app基本信息
	protected $sdkappid = 1400028643;
	protected $usersig = 'eJxljl1PgzAARd-5FU1fNdoCBeYbQeOWzOECc3MvTTcKqxsdlPIV43-X4RJJvK-n3Nz7aQAAYDyP7th*f66lprovOAQPACJ4*weLQiSUaWqp5B-kXSEUpyzVXA0QE0JMhMaOSLjUIhVXgyW5kCNcJUc6bPz27Z*y6Tm2NVZENsCXp-dgtnzc1eSt*-DZMeqD02a3iTvPLVt1SO1*G68Vb0hTVrFbhm02O-ghPpE1WrR5oJD0czy3pj0LFtMaNdn2uUElu5fR6w0Ol6vRpBY5vx6aYG-i2o4zog1XlTjLQTARJti00CXQ*DK*Ab6VXi0_';
	...
	public function openim_send_msg3( $receiver, $msg_content)
	{
	...
	function group_send_group_msg($account_id, $group_id, $text_content)
	{
		...
		array_push($msg_content, $msg_content_elem);
		$ret = $this->group_send_group_msg3($account_id, $group_id, $msg_content);
		return $ret;
	}
...
//				"From_Account" => $account_id,
	...
	function group_send_group_msg3($account_id, $group_id, $msg_content)
	{
